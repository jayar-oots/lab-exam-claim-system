...
LEFT JOIN rate_settings rs ON rs.id = 1
...
$daAmount = $row['da_per_day'];

$distance = $row['distance_km'] ?? 0;
$taAmount = $distance * 2 * $row['ta_per_km'];
...
<html>
<head>
<title>External Claim Details</title>
